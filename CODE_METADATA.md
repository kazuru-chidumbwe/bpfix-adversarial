...
**Guide for Authors (current target venue):** C2 must be a **public GitHub** repository URL (not Zenodo/GitLab as the primary permanent link). Zenodo remains an optional archival DOI in docs / references.
...
**Note:** C2 is the **GitHub tree for tag `v1.0.2`** (current venue requirement). Release: https://github.com/kazuru-chidumbwe/bpfix-adversarial/releases/tag/v1.0.2. Zenodo version DOI `10.5281/zenodo.21860453` is archival only — do not put it in C2.
