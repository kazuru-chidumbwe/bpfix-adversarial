...
| C2 | Permanent link to code/repository used for this code version | https://github.com/kazuru-chidumbwe/bpfix-adversarial/tree/v1.0.1 |
...
| C7 | If available, link to developer documentation/manual | https://github.com/kazuru-chidumbwe/bpfix-adversarial/tree/v1.0.1#readme · `docs/` · this file · optional Zenodo archive https://doi.org/10.5281/zenodo.21860453 |
...
**Note:** C2 is the **GitHub tree for tag `v1.0.1`** (SoftwareX requirement). Release: https://github.com/kazuru-chidumbwe/bpfix-adversarial/releases/tag/v1.0.1. Zenodo version DOI `10.5281/zenodo.21860453` is archival only — do not put it in C2.
