...
| Tag | Purpose |
| --- | --- |
| [`v1.0.2`](https://github.com/kazuru-chidumbwe/bpfix-adversarial/releases/tag/v1.0.2) | **SoftwareX cite pin** (current; minor-rev — tag re-cut 2026-09-14) |
...
GitHub’s `v1.0.0` tag was retargeted during early revision hygiene, so it is a release label only; do not use it to reproduce cited results. SoftwareX cites **`v1.0.2`** (GitHub C2).
