...
| --- | --- | --- | --- |
| (none) | — | `make insets`, unit tests, offline scoring | C6 offline claim |
...
**Host binaries (not pip):** clang, bpftool/libbpf, Linux kernel eBPF verifier — versions recorded in code metadata C6 and [`docs/LAB-PIN.md`](LAB-PIN.md) / `results/env_pins/`.
